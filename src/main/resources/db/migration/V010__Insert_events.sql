INSERT INTO EVENT (id, date, name, max_members, description, city_id, holder_id)
VALUES
(1, '2019-11-01 10:30',
 ...
 '1920s–1930s, other private collections were added, but Alexei Morozov’s collection remains the largest.', 1, 1),
...
(3, '2019-12-03 18:00',
 ...
 ' three centuries — from the 18th century to the present day. ', 3, 1),
...
(4, '2019-11-04 10:30',
 ...
 ' photos by Alexander Ivanishin. He captured a backstage life of the Moscow theatres. You will see rehearsals ' ||
 'captured at the Chekhov Moscow Art Theatre, the Pyotr Fomenko Workshop, the Shadow Theatre, the Stanislavsky and' ||
...
(5,'2019-10-05 15:00' ,
 ...
 ' compositions made by Soviet artists of the 1960s–1980s.', 5, 1),
...
(6, '2019-12-06 18:00',
 ...
 ' and its state rooms, see today’s theatre centre, the old Belokolonny Hall of Princess Shakhovskaya, listen to a ' ||
 'story about the famous theatre groups, and visit a unique exhibition at Zimin Lobby and Gallery.Also, visitors ' ||
 'will view new Stravinsky theatre hall. Free admission.', 6, 2),
...
(7, '2019-11-07 10:30',
 ...
 ' see the paintings ''Master of the Earth'', ''Getting Cold'', ''Waiting'', ''Fate'' and others. The artist seeks to' ||
 ' understand the Russian character and capture life in authentic and realistic manner.Full ticket — RUB 200, ' ||
 'discount ticket — RUB 80.', 7, 1),
...
(8,'2019-10-08 15:00' ,
 ...
 ' Reserve.You will see icons and graphics, as well as books from the Museum Reserve’s collection. Each image type of' ||
 ' Christ has a detailed description. Religious books have no description of how the Saviour looked like, that is why' ||
 ' his image has always been of interest for Christians. So at first one of the main image types appeared - the Holy' ||
 ' Mandylion, then the Infant Jesus with Holy Virgin, Christ Emmanuel, Christ Pantocrator.', 8, 2),
...
(9, '2019-12-09 18:00',
 ...
 ' Katran.The exhibition''s highlight is a fantasy about the climatic malfunction, which caused unprecedented' ||
 ' snowfalls in summer. At the same time, this ''natural disaster'' will be an opportunity to take a fresh look at' ||
 ' the Museum''s building and Sheremetev collection of sculptures from Moscow Ostankino Museum Estate exhibited in ' ||
 'its halls. It will be accompanied by real media reports about heavy snowfall voiced by soloist of Stanislavsky' ||
 ' Electro Theatre Alexei Kokhanov.', 9, 1),
...
(10, '2019-11-10 10:30',
 ...
 ' from Russia and other countries presenting their works.', 10, 2),
...
(11,'2019-10-11 15:00' ,
 ...
 'things that served as the background for dramatic scenes of literary works by Russian and European classics.', 11, 1),
...
(12, '2019-12-12 18:00',
 ...
 ' school, such as Ivan Generalić, Mijo Kovačić, Ivan Večenaj, Dragan Gaži and Ivan Lacković.', 12, 2),
...
(13, '2019-11-13 10:30',
 ...
 ' Moscow and regional museums.Jacob Jordaens was born in 1593. Together with Peter Rubens, he was learning art from' ||
 ' the famous Adam van Noort. The representatives of Charles I of England, Queen Henrietta Maria of France and the' ||
 ' House of Orange-Nassau were among his customers.', 13, 1),
...
(14,'2019-10-14 15:00' ,
 ...
 ' Edith Piaf, Marcello Mastroianni, Pierre Cardin, Brigitte Bardot, and many others.', 14, 2),
...
(15, '2019-12-15 18:00',
 ...
 ' dominance in the arts throughout her career. Rosemarie Trockel contrasts the figure of a male artist genius with' ||
 ' female role models and meanings. In an ironic and humorous way, she highlights the prejudices women face in ' ||
 ' societyand the arts.', 15, 1),
...
(16, '2019-11-16 10:30',
 ...
 ' Nikita Khrushchev in 1962.', 16, 2),
...
(17,'2019-10-17 15:00' ,
 ...
 ' Benson really world-famous.', 17, 1),
...
(19, '2019-11-19 10:30',
 ...
 ' Utesov, Mark Bernes, Iya Savvina, Yelena Koreneva, Alexander Gradsky and other artists.', 19, 1),
...
(22, '2019-12-21 18:00',
    ...
    ' one can only perceive its meaning.', 22, 2),
...
(23, '2019-12-21 18:00',
    ...
    ' 21st Century Gallery is opening the exhibition ''Proto-signs'' by Nikolai Selivanov.''Proto-sign'' is a concept' ||
    ' to describe an artwork without words. A proto-sign cannot be fully understood, but' ||
    ' one can only perceive its meaning.', 23, 1),

(24, '2019-12-21 18:00',
    '''Proto-signs'' at the 21st Century Gallery',
    2000,
    ' 21st Century Gallery is opening the exhibition ''Proto-signs'' by Nikolai Selivanov.''Proto-sign'' is a concept' ||
    ' to describe an artwork without words. A proto-sign cannot be fully understood, but one can only perceive its' ||
    ' meaning.', 24, 2);
